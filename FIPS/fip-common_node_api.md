...
| ChainGetBlockMessages               | State query      | Returns all message from the specified block                                                                                                                                                                                                                                                                                                                                                                                                   |
...
| ChainPutObj                         | <uncategorized>  | Puts a given object into the block store                                                                                                                                                                                                                                                                                                                                                                                                       |
...
| NetAgentVersion                     | Node operation   | Returns agent version string                                                                                                                                                                                                                                                                                                                                                                                                                   |
...
| StateGetAllocations                 | State query      | returns the all the allocations for a given client                                                                                                                                                                                                                                                                                                                                                                                             |
